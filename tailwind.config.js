...
const { animationsPlugin } = require('./tailwind/animations');
const { allSpacing, extendedSpacing, spacingPlugins } = require('./tailwind/spacing');
const { gradientsPlugin } = require('./tailwind/gradients');
const { anchorsPlugin } = require('./tailwind/anchors');
const tailwindcssInteractionVariants = require('tailwindcss-interaction-variants');
...
module.exports = {
  ...
  variants: [
    ...
    'first',
    'last',
    // from tailwindcssInteractionVariants
    'group-focus-within',
  ],
  plugins: [spacingPlugins, animationsPlugin, gradientsPlugin, anchorsPlugin, tailwindcssInteractionVariants],
};
